...
exports.resendVerificationEmail = functions
    ...
    try {
        ...
        if (userData === null || userData === void 0 ? void 0 : userData.email_verified) {
          ...
          <html>
            ...
            <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #1e293b; max-width: 600px; margin: 0 auto; padding: 20px;">
              <div style="background: #ffffff; border-radius: 12px; padding: 40px; border: 1px solid #e2e8f0;">
                ...
                <h2 style="color: #1e293b; font-size: 20px; font-weight: 700; margin-bottom: 16px;">Hi ${(userData === null || userData === void 0 ? void 0 : userData.name) || (userData === null || userData === void 0 ? void 0 : userData.full_name) || 'User'},</h2>
        ...
        functions.logger.info(`Verification email sent to ${userData === null || userData === void 0 ? void 0 : userData.email}`);
        return {
            success: true,
...
exports.verifyPasswordResetTokenHttp = functions.https.onRequest(async (req, res) => {
    // Set CORS headers
    res.set('Access-Control-Allow-Origin', '*');
    res.set('Access-Control-Allow-Methods', 'POST');
    res.set('Access-Control-Allow-Headers', 'Content-Type');
...
exports.requestPasswordResetHttp = functions
    .runWith({ secrets: [RESEND_API_KEY] })
    ...
    try {
        ...
        const existingTokens = await db.collection('verification_tokens')
            ...
            .where('used', '==', false)
            .get();
        const invalidationPromises = existingTokens.docs.map(tokenDoc => tokenDoc.ref.update({
            used: true,
            invalidated_at: admin.firestore.FieldValue.serverTimestamp(),
            invalidated_reason: 'new_token_requested'
        }));
